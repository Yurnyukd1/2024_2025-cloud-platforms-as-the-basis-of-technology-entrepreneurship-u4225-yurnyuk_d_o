...
### Описание приложения
Приложение — **"Fit Answer"** — предназначено для помощи пользователям в составлении сбалансированного плана питания, с учетом их целей, здоровья, аллергий и предпочтений. Основные функциональные возможности:
...
<img width="975" alt="image" src="https://github.com/user-attachments/assets/6fee0848-578f-4946-b10b-93013a8b5016" />
...
### Выводы
В рамках лабораторной работы была создана инфраструктурная схема для приложения "Fit Answer" на облачных платформах Google Cloud и AWS. Задача заключалась в разработке гибкой инфраструктуры для трех этапов: начального, тестирования и продового решения.
